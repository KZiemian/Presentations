...
\begin{frame}
  ...
  musi najpierw przetłumaczyć ją na język asemblera. To co kupuje nabywając
  \textit{Hollow Knight}, to jest właśnie kod w~języku asemblera.
...
% ######################################
\section{Cechy kompilatorów i~interpreterów}
% ######################################
