...
\begin{frame}
  ...
  Kompilator dokonuje \alert{tylko} przekładu z~jednego języka na drugi,
  \alert{nie} uruchamia jednak tego programu. Używając prostego
  przykładu, kompilator przetłumaczy „Eat the soup.” na „Zjedz zupę.”, ale
  nie mówi nikomu, że~ma zjeść zupę.
