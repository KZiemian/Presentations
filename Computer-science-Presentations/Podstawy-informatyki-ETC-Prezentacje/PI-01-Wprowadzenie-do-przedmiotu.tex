...
\begin{frame}
  ...
  mieli Państwo okazję oswoić~się z~tworzeniem działających programów w~C,
  nawet jeśli są one bardzo proste. Zagadnienia teoretyczne i~bardziej
  techniczne, które dobry programista musi znać, będę w~miarę możliwości
  omawiane na późniejszych zajęciach.
...
\begin{frame}
  ...
  mnie wyrozumiałość w~tym względzie.
...
\begin{frame}
  ...
  może na~długo zaginąć na mojej skrzynce pocztowej.
