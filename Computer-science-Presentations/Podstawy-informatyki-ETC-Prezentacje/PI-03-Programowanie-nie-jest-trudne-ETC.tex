...
% ######################################
\section{Logika i~algebry Boole’a}
% ######################################
...
\begin{frame}
  ...
  możemy napisać choćby następujący kod. Jego pełna wersja


  Musimy też wskazać na pewną osobliwość spójnika \texttt{\&\&}. Rozpatrzmy
  zdanie \\
  „Jan je kanapkę \texttt{\&\&}
