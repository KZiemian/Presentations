...
% Local packages
% ------------------------------
\usepackage{./Local-packages/auxiliary-commands}
...
\begin{frame}
  ...
  z~>>Harry’ego Pottera”. Ja od trzech godzin siedzę nad piątym i~powoli
  tracę zmysły, a~kolega obok jeszcze nie ukończył pierwszego.”.
