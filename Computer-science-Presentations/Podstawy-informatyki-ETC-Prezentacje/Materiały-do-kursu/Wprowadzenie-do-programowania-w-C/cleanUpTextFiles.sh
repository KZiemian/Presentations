...
# Script for cleaning up files with text output of C programs.

# text_file_to_clean_up="PI-01-A-Text-output.txt"
...
# text_file_to_clean_up="PI-02-A-Text-output.txt"
...
# text_file_to_clean_up="PI-02-B-Text-output.txt"
...
# text_file_to_clean_up="PI-02-C-Text-output.txt"
...
# text_file_to_clean_up="PI-03-B-Text-output.txt"
...
text_file_to_clean_up="PI-04-F-Text-output.txt"
...
text_file_to_clean_up="PI-05-A-Text-output.txt"
