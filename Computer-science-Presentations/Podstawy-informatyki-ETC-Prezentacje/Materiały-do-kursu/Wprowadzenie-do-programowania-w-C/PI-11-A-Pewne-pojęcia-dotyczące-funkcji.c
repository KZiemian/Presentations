...
/* Wprowadzimy teraz trochę pojęć opisujących funkcje w języku C.
 * To jest konieczne, żeby zrozumieć pewne rzeczy na temat tego języka. */
 ...
 *
 * Ktoś mógłby uznać, że wprowadzenie tego pojęcia, to marnowanie sił
