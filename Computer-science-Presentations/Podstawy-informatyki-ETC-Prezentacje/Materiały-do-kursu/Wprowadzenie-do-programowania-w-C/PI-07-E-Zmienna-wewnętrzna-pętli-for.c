...
int main() {
  ...
  /* Zmienną wewnętrzną pętli definujemy w pierwszej części nawiasu
   * okrągłego następującego po słowie „for”. Definicja ta ma standardową
   * postać: najpierw typ zmienne, potem jej nazwa. Z tym związane są pewne
   * subtelności, o których powiemy później. */
  for (int i = 0; i < 3; i++) {
