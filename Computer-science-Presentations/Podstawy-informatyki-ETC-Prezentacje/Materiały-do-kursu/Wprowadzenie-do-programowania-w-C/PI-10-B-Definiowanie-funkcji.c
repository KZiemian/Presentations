 ...
 * double linearFunction(double x)
 * Ta linia kodu ma zawsze taką samą strukturę. Najpierw jest nazwa typu,
 * która określa jaki jest typ wartości zwracanej przez funkcję.
 *
 ...
 * „linearFunction”. Następnie mamy nawias okrągły, w którym określmy jakie
 * argumenty pobiera ta funkcja. Dokładniej, w języku C musimy najpierw podać
 * typ argumentu jaki prześlemy danej funkcji, później jaka jest jego nazwa
 * wewnątrz funkcji. W naszym wypadku mamy argument o nazwie „x” i typie
 * double.
 *
 ...
 * wyrażenie 2.0 * x + 1.0 i zwróć ten rezultat jako wartość o typie double.
 * Mówiliśmy już o typie zwracanego rezultatu omawiając linię
 * linearFunction(1.0)
 *
