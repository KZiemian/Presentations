...
int main() {
  ...
  /* Funkcja describeNumber() NIE ZWRACA niczego, ale wypisuje pewien tekst
   ...
   *
   * Funkcje typu void są użyteczne, bo niekiedy funkcję wywołujemy nie po to,
   ...
   * Czy to jest dla Państwa wystarczająco zrozumiałe?
   *
