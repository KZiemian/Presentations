...
\begin{frame}
  ...
  i~języku~C. W~związku z~tym, ja będziemy Państwa rozliczać tylko
  i~wyłącznie z~umiejętności i~wiedzy, i~z~niczego innego. Wychodzimy bowiem
  z~założenia, że~Państwo sami najlepiej wiedzą, czemu warto poświęcić swój
  czas. (Choć sami potem często żałujemy naszych wyborów.)
...
\begin{frame}
  ...
  bardziej czuje co to jest program komputerowy, niż umie to jawnie
  wysłowić.
...
\begin{frame}
  ...
  ale już zbyt na tyle skomplikowany, że~trudno zrozumieć lub napisać
...
\begin{frame}
  ...
  w~Pythonie, JavaScripcie,~etc. Z~powodów które powinny być dla wszystkich
...
\begin{frame}
  ...
  Łatwo się to mówi, ale mimo tego warto spróbować.
...
\begin{frame}
  ...
  Ile będzie zestawów zadań? Prawdopodobnie około siedmiu.
  ...
  myśleć jako o~sposobie na nauczenia~się tworzenia programów, a~nie
...
\begin{frame}
  ...
  nazywanie plików nie jest to $100$\% obowiązkowe, ale gdy~się dostaje
  $50$~rozwiązań jednego zestawu zadań, to naprawdę nam pomaga.
...
\begin{frame}
  ...
  nas. Jeśli Państwo chcą byśmy ustalili konkretny terminy na konsultacje,
  to proszę jako grupa wybrać jeden konkretny i~poinformować nas o~tym
  e-mailowo, pisząc na adres \email. W~tytule maila proszę napisać
  \textit{Termin konsultacji} lub coś podobnego, byśmy wiedzieli, że~na ten
  e-mail należy możliwie szybko odpowiedzieć.
...
\begin{frame}
  ...
  Ponawiamy prośbę o~nadanie takiemu e-mailowi tytułu typu \textit{Termin
    konsultacji}, bo przy liczbie e-maili jakie trafiają na tę skrzynkę
  ...
  już nie jest łatwe. Sami przez to przechodziliśmy.
