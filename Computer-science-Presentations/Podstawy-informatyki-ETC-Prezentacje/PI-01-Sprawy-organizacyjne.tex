...
\begin{frame}
  ...
  i~programowaniu w~języku~C. W~związku z~tym, ja będziemy Państwa
...
\begin{frame}
  ...
  Naszym obowiązkiem jest przedstawiać tematykę zajęć możliwie prosto
...
\begin{frame}
  ...
  Wszystkie to są bardzo dobre pytania. Tylko dlatego, że~pytanie jest
  bardzo proste w~postawieniu, nie oznacza, że~jest ono głupie. Prawdziwym
  problemem jest to, że~na~takie proste pytania, często bardzo trudno
  udzielić satysfakcjonującej odpowiedzi. Bo większość informatyków
  bardziej czuje co to jest program komputerowy, niż umie to wprost
  wysłowić.
...
\begin{frame}
  ...
  jest Państwa opinia w~tej sprawie? To jest dla nas bardzo ważne.
...
\begin{frame}
  ...
  zagadnienia. Zrozumienie co jest dla Państwa proste, a~co trudniejsze, to
  jest naprawdę niełatwe zadanie.
  ...
  % \textit{\alert{Podstaw} informatyki}, który ma położyć fundamenty pod
...
\begin{frame}
  ...
  lub coś podobnego, bo inaczej może utknąć na długo w~naszej skrzynce,
...
\begin{frame}
  ...
  do wykładowców, bo tylko oni mogą taką zmianę wprowadzić.
...
\begin{frame}
  ...
  ale już na tyle skomplikowany, że~trudno zrozumieć lub napisać
  ...
  jest to wcale łatwo przekazać na~zajęciach.
...
\begin{frame}
  ...
  Początkowo prace domowe są bardzo prosto, jak na ten przedmiot. Z~czasem
  ich trudność, jak i~punkty do zdobycia za nie rosną. Układanie dobrych
  zestawów zadań to trudna sztuka, stąd będziemy wdzięczni za~wszystkie
  uwagi jak można je poprawić, proszę je przesyłać na adres \email.
  Przypominam, że~o tych zestawach lepiej myśleć jako o~sposobie na
  nauczenia~się tworzenia programów, a~nie nieprzyjemnym obowiązku do
  odhaczenia. Easier said than done, wiemy o~tym.
  ...
  nauki będą zamieszczone źródła, z~większą liczbą zadań do~rozwiązania.
...
\begin{frame}
  ...
  przesyłanie mi tych wytworów czeluści piekielnych nie stracą Państwo
  punktów.
...
\begin{frame}
  ...
  go w~innym terminie, też na żywo i~w~sali zajęciowej.
  ...
  który już przerobiliśmy wspólnie na zajęciach. Doświadczenie pokazuje,
