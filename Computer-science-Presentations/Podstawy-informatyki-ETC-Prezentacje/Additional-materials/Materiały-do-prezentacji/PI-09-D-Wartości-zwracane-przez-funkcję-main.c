...
/* Należy wyjaśnić jaka jest rola wartości zwracanej przez funkcję main.
   ...
   Po drugie, przyjąto zasadę, że coś może się udać na jeden sposób, za to
...
/* Jeszcze jeden komentarz dotyczy tego, że powiedzieliśmy, iż każdy
   ...
   Odpowiedź jest taka, że w jęzuku istnieją programy pomocnicze, których nie
   można bezpośrednio uruchomić i one z definicji nie posiadają funkcji
