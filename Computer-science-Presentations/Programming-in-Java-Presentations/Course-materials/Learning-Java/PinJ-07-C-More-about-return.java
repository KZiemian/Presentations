class TwoNumbers {
	...
	// This behavior is logical if you think about method as thing
	// that takes some data as input and return a result. After
	// method returns a result, there is nothing more to do for it,
	// so can be ended.

	// So every code after return is unrechable and Java consider it
	// existence as error.
...
class Main {
	...
	// type void is correct. At some level this make sens.
	return;

	// But putting unreachable code after returning nothing is an error.
	// Again, at some level this make sense.
