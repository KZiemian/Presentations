...
// be still doing that, because it is convenient and we still have a lot to
...
// and more, to create pages containing special kind of comments that were
...
// comments from the C language, but look more strange. We see exemple
