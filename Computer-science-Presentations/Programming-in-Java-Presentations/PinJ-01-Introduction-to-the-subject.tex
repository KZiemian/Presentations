...
\begin{frame}
  ...
  Also, we know that our subject is far from being perfect and we are
...
\begin{frame}
  ...
  external constraints can limit our ability to make this subject as hands-on
  as we want, but we will do what we can.

  We are still developing learning materials for this course, you will
  have access to them by Sake. We hope that this materials will help you
  learn the basics of Java. They are by no means perfect, so please, if
  you found any mistake in them, like bad English language, write to us at
  ...
  Or you may check and download them just using web browser under this link
...
\begin{frame}
  ...
  Materials for \textit{Programming in Java} are inside directory \\
...
\begin{frame}
  ...
  we will have a~$45$~minutes live exam. Half of the mark is form homework
  ...
  chat\textsc{gpt} and other such live checks of your knowledge is a
  necessity for us.
...
\begin{frame}
  ...
  that need to run with your implementation of such a~class.''
